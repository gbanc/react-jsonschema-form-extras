...
function CollapseMenu(props) {
  ...
  var _props$uiSchema$colla3 = _props$uiSchema$colla2.valid,
      valid = _props$uiSchema$colla3 === undefined ? "glyphicon glyphicon-plus-sign" : _props$uiSchema$colla3,
      _props$uiSchema$colla4 = _props$uiSchema$colla2.enabled,
      enabled = _props$uiSchema$colla4 === undefined ? "glyphicon glyphicon-chevron-down" : _props$uiSchema$colla4,
      _props$uiSchema$colla5 = _props$uiSchema$colla2.disabled,
      disabled = _props$uiSchema$colla5 === undefined ? "glyphicon glyphicon-chevron-right" : _props$uiSchema$colla5,
      _props$uiSchema$colla6 = _props$uiSchema$colla2.add,
      add = _props$uiSchema$colla6 === undefined ? "glyphicon glyphicon-plus-sign" : _props$uiSchema$colla6,
      _props$uiSchema$colla7 = _props$uiSchema$colla.separate,
      separate = _props$uiSchema$colla7 === undefined ? true : _props$uiSchema$colla7,
      addTo = _props$uiSchema$colla.addTo,
      _props$uiSchema$colla8 = _props$uiSchema$colla.wrapClassName,
      wrapClassName = _props$uiSchema$colla8 === undefined ? "lead" : _props$uiSchema$colla8,
      _props$uiSchema$colla9 = _props$uiSchema$colla.actions,
      actions = _props$uiSchema$colla9 === undefined ? [] : _props$uiSchema$colla9,
      _props$uiSchema$colla10 = _props$uiSchema$colla.classNames,
      classNames = _props$uiSchema$colla10 === undefined ? "collapsibleHeading" : _props$uiSchema$colla10,
      _props$uiSchema$colla11 = _props$uiSchema$colla.collapseDivStyles;
  _props$uiSchema$colla11 = _props$uiSchema$colla11 === undefined ? {} : _props$uiSchema$colla11;
  var _props$uiSchema$colla12 = _props$uiSchema$colla11.textColor,
      textColor = _props$uiSchema$colla12 === undefined ? "white" : _props$uiSchema$colla12,
      _props$uiSchema$colla13 = _props$uiSchema$colla11.background,
      background = _props$uiSchema$colla13 === undefined ? "linear-gradient(to right, #0472B6, white)" : _props$uiSchema$colla13,
      _props$uiSchema$colla14 = _props$uiSchema$colla11.collapseGlyphColor,
      collapseGlyphColor = _props$uiSchema$colla14 === undefined ? "white" : _props$uiSchema$colla14,
      _props$uiSchema$colla15 = _props$uiSchema$colla11.addGlyphColor,
      addGlyphColor = _props$uiSchema$colla15 === undefined ? "white" : _props$uiSchema$colla15,
      _props$uiSchema$colla16 = _props$uiSchema$colla11.padding,
      padding = _props$uiSchema$colla16 === undefined ? "14px" : _props$uiSchema$colla16,
      _props$uiSchema$colla17 = _props$uiSchema$colla11.margin,
      margin = _props$uiSchema$colla17 === undefined ? "" : _props$uiSchema$colla17,
      _props$uiSchema$colla18 = _props$uiSchema$colla11.marginLeft,
      marginLeft = _props$uiSchema$colla18 === undefined ? "-5px" : _props$uiSchema$colla18,
      _props$uiSchema$colla19 = _props$uiSchema$colla11.marginBottom,
      marginBottom = _props$uiSchema$colla19 === undefined ? "5px" : _props$uiSchema$colla19,
      _props$uiSchema$colla20 = _props$uiSchema$colla11.zIndex,
      zIndex = _props$uiSchema$colla20 === undefined ? -1 : _props$uiSchema$colla20,
      _props$uiSchema$colla21 = _props$uiSchema$colla11.divCursor,
      divCursor = _props$uiSchema$colla21 === undefined ? "pointer" : _props$uiSchema$colla21,
      _props$uiSchema$colla22 = _props$uiSchema$colla11.addCursor,
      addCursor = _props$uiSchema$colla22 === undefined ? "copy" : _props$uiSchema$colla22,
...
var CollapsibleField = function (_Component5) {
  ...
  function CollapsibleField(props) {
    ...
    var _props$uiSchema$colla23 = props.uiSchema.collapse;
    _props$uiSchema$colla23 = _props$uiSchema$colla23 === undefined ? {} : _props$uiSchema$colla23;
    var _props$uiSchema$colla24 = _props$uiSchema$colla23.collapsed,
        collapsed = _props$uiSchema$colla24 === undefined ? true : _props$uiSchema$colla24;
